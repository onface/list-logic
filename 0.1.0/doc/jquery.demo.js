...
/******/ 	__webpack_require__.p = "/page/0.1.0";
/******/
...
var Page = __webpack_require__("./lib/index.js");
...
$(function () {
    ...
    var page = new Page({
        ...
        willFetch: function willFetch(resolve, reject) {
        ...
        fetch: function fetch(queryData, render, didFetch) {
        ...
        render: function render(res, queryData) {
            // render list
...
var _sparejs = __webpack_require__("./node_modules/sparejs/index.js");
...
var _query = function _query(data, callback) {
    var self = this;
    ...
    new Promise(self.options.willFetch).then(function () {
        self.options.fetch(fetchQuery, function render() {
            rendered = true;
            ...
            setTimeout(function () {
                ...
                callback({ end: 'didFetch', rendered: rendered });
            }, 0);
        });
    }).catch(function () {
        callback({
...
spare.settings = __webpack_require__("./node_modules/sparejs/settings.js")
module.exports = spare


/***/ }),

/***/ "./node_modules/sparejs/settings.js":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__("./doc/jquery.demo.js");
